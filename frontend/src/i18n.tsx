...
const dict = {
  es: {
    ...
    "contracts.label.consultant": "PROVEEDOR",
    ...
    "newc.field.consultant": "Proveedor",
  ...
  en: {
    ...
    "contracts.label.consultant": "PROVIDER",
    ...
    "newc.field.consultant": "Provider",
    "newc.field.product": "Product",
    "newc.field.value": "Value",
    "newc.field.currency": "Currency",
    "newc.field.days": "Duration (days)",
    "newc.field.signed": "Signed date (YYYY-MM-DD)",
    "newc.field.payBreakdown": "Payment breakdown",
    "newc.field.payType.anticipo": "Advance",
    "newc.field.payType.hito": "Milestone",
    "newc.field.payType.adenda": "Addendum",
    "newc.field.payType.contra_entrega": "On delivery",
    "newc.field.payType.final": "Final payment",
    "newc.import": "Import from PDF/Word",
    "newc.import.busy": "Extracting with AI...",
    "newc.import.done": "Fields filled",
    "newc.import.err": "Could not extract",
